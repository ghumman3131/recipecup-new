...
public class Comments extends AppCompatActivity {
    ...
    public void send_comment(View view) {
        ...
        try {
            job.put("r_id" , getIntent().getStringExtra("r_id"));
        ...
        JsonObjectRequest jobreq = new JsonObjectRequest("http://"+Ipaddress.ip+"/add_comment.php", job, new Response.Listener<JSONObject>() {
            @Override
    ...
    private void get_comments()
    {
        ...
        JsonObjectRequest jobreq = new JsonObjectRequest("http://"+Ipaddress.ip+"/get_comment.php", job, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
